...
set confhome=https://raw.githubusercontent.com/herobrauni/reinstall/main
set confhome_cn=https://cnb.cool/herobrauni/reinstall/-/git/raw/main
rem set confhome_cn=https://www.ghproxy.cc/https://raw.githubusercontent.com/herobrauni/reinstall/main
